...
export namespace Browser {
    ...
    export namespace printerProvider {
        ...
        /** from https://developer.Browser.com/docs/apps/reference/usb#type-Device */
    ...
    */
    ...
    export namespace tabs {
        ...
        /**
         * Captures the visible area of the currently active tab in the specified window. In order to call this method, the extension must have either the [<all\_urls>](https://developer.Browser.com/extensions/develop/concepts/declare-permissions) permission or the [activeTab](https://developer.Browser.com/docs/extensions/develop/concepts/activeTab) permission. In addition to sites that extensions can normally access, this method allows extensions to capture sensitive sites that are otherwise restricted, including chrome:-scheme pages, other extensions' pages, and data: URLs. These sensitive sites can only be captured with the activeTab permission. File URLs may be captured only if the extension has been granted file access.
         *
         * Can return its result via Promise in Manifest V3 or later since Chrome 88.
    ...
    export namespace declarativeNetRequest {
         ...
         * *   {@link MAX_NUMBER_OF_DYNAMIC_RULES} is the maximum number of dynamic rules an extension can add. The number of [unsafe rules](https://developer.Browser.com/docs/extensions/reference/declarativeNetRequest/#safe_rules) must not exceed {@link MAX_NUMBER_OF_UNSAFE_DYNAMIC_RULES}.
         *
         * Can return its result via Promise in Manifest V3 or later since Chrome 91.
         */
